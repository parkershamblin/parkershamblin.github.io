...
`const social = [
    ...
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:parkershamblin@gmail.com",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Parker Shamblin's Portfolio",
    description: "Portfolio website showcasing my work as a Design Engineer",
    headline: <>Software Engineer</>,
    subline: (
      <>
        I'm Parker, a software engineer at the <InlineCode>University of South Florida</InlineCode>, where I craft intuitive
